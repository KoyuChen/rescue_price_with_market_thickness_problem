"""Isolated restartable solver using tail-bounded rare conditional posteriors.
...
from rare_history_evaluator import RareHistoryEvaluator as CachedEnvelopeEvaluator
        ...
        for step in range(state['next_step'], steps):
            ...
            if progress and step % 5 == 0:
                progress(dict(stage='iteration', temperature=temperature,
                    ...
                    rare_history_resolution=ev.get('rare_history_resolution',[])))
