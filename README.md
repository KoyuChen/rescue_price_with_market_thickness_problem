...
最新实际结果见 [docs/M3_RESULTS_20260906.md](docs/M3_RESULTS_20260906.md)：m=3 的
rescue/flat 均已通过两组百万样本审计，千万配对市场固定菜单增益为 +1.14485 个百分点。
m=3 外层搜索已另行启动；上述固定菜单比较不是优化后的 V*(3)，也不是单峰结论。
